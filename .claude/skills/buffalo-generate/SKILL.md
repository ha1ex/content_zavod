...
> **ОБЯЗАТЕЛЬНО:** при сборке любого лендинга всегда подключай дизайнерский скилл **[`design-system-kaiten-v01`](../design-system-kaiten-v01/SKILL.md)**. Его токены, сетки, правила компонентов и правило про висячие предлоги (`&nbsp;`) применяются к каждому макету. Не собирай и не проверяй лендинг без активного дизайнерского скилла.
...
- **Always engage the designer skill.** При любой сборке/итерации/ревью лендинга держи активным [`design-system-kaiten-v01`](../design-system-kaiten-v01/SKILL.md) — токены, сетки, состояния компонентов и проверку текста на висячие предлоги (`&nbsp;`). Лендинг, собранный без дизайнерского скилла, считается несданным.
