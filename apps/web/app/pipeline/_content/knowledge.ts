...
export const KNOWLEDGE: PipelineDoc[] = [
...

  {
    ...
    purpose: [
      ...
      'Проверки стоят в четырёх точках: публикация брифа (intake-apply), сборка страницы (apply в быстром конвейере или гейты фаз в поэтапном), генерация иллюстраций и финальный аудит непохожести лендингов между собой.',
    ],
    rules: [
      {
