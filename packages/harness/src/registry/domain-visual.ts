...
export const DOMAIN_REGISTRY: DomainEntry[] = [
  {
    ...
    mocks: [
      ...
      {
        variant: 'module-task-card',
        sections: ['media', 'tab'],
        description:
          'Доска Кайтена «Маркетинг» (колонки от «Очередь» до «Готово», дорожки «Запуск продукта» и «Разработка») с открытым справа окном карточки «Промостраница новой функции»: параметры, чек-лист 3/5, описание, дочерние карточки и комментарий — «вся информация по задаче в карточке»',
      },
      {
        variant: 'admin-space',
        sections: ['media', 'tab'],
      ...
      {
        variant: 'window-notification-settings',
        sections: ['media', 'tab'],
        description:
      ...
      {
        variant: 'window-recurring-schedule',
        sections: ['media'],
        description:
