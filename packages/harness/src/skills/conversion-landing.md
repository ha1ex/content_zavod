...
# Контент-завод Кайтен — Conversion Landing Skill

> **Что это.** Контракт-руководство для всех, кто собирает или правит лендинги
> через Контент-завод Кайтен. Покрывает full lifecycle: discovery → page type →
...
- Брендовый запрос («kaiten signup») → most-aware.
- «Контент-завод Кайтен vs Webflow» → product-aware.
...
- **H1 ≤ 45 знаков**, формула: `[Продукт как альтернатива] [бренду]`.
  Пример: «Контент-завод Кайтен vs Webflow: SSR-лендинги без CMS».
...
### 4.A Маппинг каталога на Контент-завод Кайтен LandingSpec
...
| Comparison/vs | `[Мы] как альтернатива [бренду]: [главный benefit]` | «Контент-завод Кайтен vs Webflow: SSR-лендинги без CMS» |
...
В Контент-завод Кайтен это `IllustrationSpec`:
...
В Контент-завод Кайтен формы как таковой нет — CTA-кнопка ведёт на signup-flow вне страницы.
...
**Ориентир Контент-завод Кайтен.** Сгенерированный лендинг должен набирать ≥ 75/100 в
...
- **Event конверсии** — для встроенных CTA href, у которых есть UTM-параметры:
  `utm_source=kaiten`, `utm_medium=landing`, `utm_campaign=<slug>`.
...
## 17. Использование в Контент-завод Кайтен pipeline
