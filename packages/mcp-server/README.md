...
| `build_landing` | Auto-routing генерация: `harness agent build landing`. Pipeline сам решит legacy/phased/manual-creation. Требует API-ключ для LLM или прохождение agent-mode flow через host-LLM. |
