...
/**
 * Секция FAQ лендинга — точь-в-точь FAQ реальных лендингов Kaiten (эталон,
 * палитра V01). Тексты вопросов/ответов приходят пропсами.
 *
 * Поведение:
 ...
 *  - раскрытый пункт: белый фон + лиловая рамка + лиловый вопрос;
 ...
 * Self-contained: scoped `<style>` под `.faq-mock`.
 *
 * Дефолт пайплайна для всех FAQ-секций (правило `faq-uses-mock`).
 */
...
@media(max-width:767px){
  ...
  .faq-mock .faq-section__head{align-items:flex-start;}
  .faq-mock .faq-section__eyebrow{text-align:left;}
  .faq-mock .faq-section__title{font-size:24px; line-height:32px; text-align:left;}
  .faq-mock .faq-section__desc{font-size:16px; line-height:24px; text-align:left;}
    ...
    <section className="faq-mock" aria-label="Часто задаваемые вопросы">
      ...
      <div className="faq-section__container">
        <div className="faq-section__head">
          {eyebrow && <p className="faq-section__eyebrow">{eyebrow}</p>}
