...
const MENU: MenuItem[] = [
  ...
  { i: 0, board: '#e0306e', label: 'Пространство руководителя', chev: 'r' },
  { i: 0, board: '#2f9fd0', label: 'Продакт-менеджмент', chev: 'r' },
  { i: 0, board: '#7d4ccf', label: 'Служба поддержки' },
...
function Sidebar() {
  return (
    <div className="side">
      <div className="side__hd"><span>Меню</span><span className="side__muted"><MenuChev dir="l" /></span></div>
      ...
      <div className="side__foot">
        <div className="side__it"><MenuBoard color="#2f9fd0" /><span className="side__lbl">Шаблоны пространств</span></div>
