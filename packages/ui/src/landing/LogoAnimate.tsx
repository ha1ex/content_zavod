...
/**
 * LogoAnimate — переиспользуемый мокап блока доверия Kaiten:
...
export interface LogoAnimateProps {
...
.lmq{
  ...
  --_font:var(--font,'Roboto','Inter',system-ui,-apple-system,'Segoe UI',sans-serif);
  --_ls:var(--ls,-0.2px);
