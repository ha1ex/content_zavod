 ...
 * фронтальная камера, мягкая внешняя и внутренняя тень. Слева к скриншоту
...
export function TabletImageMock({
  ...
  return (
    ...
    >
      {/* front camera */}
      <span aria-hidden className="absolute left-1/2 top-1 z-30 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-(--color-border-default)" />
