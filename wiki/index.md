...
- [`design-system/components/hero.md`](design-system/components/hero.md) — HeroSection _(updated: 2026-05-15)_
- [`design-system/components/icon-box.md`](design-system/components/icon-box.md) — IconBox _(updated: 2026-06-03)_
- [`design-system/components/logo_kaiten.md`](design-system/components/logo_kaiten.md) — LogoKaiten _(updated: 2026-06-03)_
- [`design-system/components/pricing.md`](design-system/components/pricing.md) — PricingPlans _(updated: 2026-05-15)_
- [`design-system/components/step-marker.md`](design-system/components/step-marker.md) — StepMarker _(updated: 2026-06-03)_
- [`design-system/grid.md`](design-system/grid.md) — Grid _(updated: 2026-05-15)_
- [`design-system/motion.md`](design-system/motion.md) — Motion _(updated: 2026-05-15)_
- [`design-system/radius.md`](design-system/radius.md) — Radius _(updated: 2026-05-15)_
- [`design-system/spacing.md`](design-system/spacing.md) — Spacing _(updated: 2026-05-15)_
- [`design-system/typography.md`](design-system/typography.md) — Typography _(updated: 2026-05-15)_
- [`design-system/voice.md`](design-system/voice.md) — Voice & Tone _(updated: 2026-05-15)_
...
- [`design-system/components/illustration-styles.md`](design-system/components/illustration-styles.md) — Illustration Styles _(updated: —)_
- [`design-system/components/navigation.md`](design-system/components/navigation.md) — Navigation _(updated: —)_
...
- [`marketing/run-with-codex.md`](marketing/run-with-codex.md) — Запуск Контент-завода под Codex / Gemini / любым агентом _(updated: —)_
- [`marketing/troubleshooting.md`](marketing/troubleshooting.md) — Что-то пошло не так — troubleshooting _(updated: —)_

## reference

- [`references/anglicism-dictionary.md`](references/anglicism-dictionary.md) — Словарь англицизмов Kaiten — источник истины по лексике (§10)
...
- [`layouts/case-study-deep-dive.md`](layouts/case-study-deep-dive.md) — Layout — Case study deep-dive
- [`layouts/comparison-vs-competitor.md`](layouts/comparison-vs-competitor.md) — Layout — Comparison vs competitor
- [`layouts/compliance-first-enterprise.md`](layouts/compliance-first-enterprise.md) — Layout — Compliance-first enterprise
- [`layouts/crm-product-tour.md`](layouts/crm-product-tour.md) — Layout — CRM product tour (interactive, не-MediaCopy ритм)
- [`layouts/depersonalized-product-tour.md`](layouts/depersonalized-product-tour.md) — Layout — Depersonalized product tour (обезличенный CRM/SMB-SaaS)
- [`layouts/enterprise-modular-saas.md`](layouts/enterprise-modular-saas.md) — Layout — Enterprise modular SaaS
- [`layouts/migration-from-competitor.md`](layouts/migration-from-competitor.md) — Layout — Migration from competitor
- [`layouts/product-launch.md`](layouts/product-launch.md) — Layout — Product launch
- [`layouts/single-module-deep-dive.md`](layouts/single-module-deep-dive.md) — Layout — Single module deep dive
- [`layouts/story-led-unaware.md`](layouts/story-led-unaware.md) — Layout — Story-led for unaware audience

## audience-scoring

- [`audiences/kaiten-scoring.md`](audiences/kaiten-scoring.md) — Kaiten — скоринг целевой аудитории (B-сегмент, 20–250 лицензий)

## index

- [`landings/index.md`](landings/index.md) — Landings — каталог

## layout-index

- [`layouts/index.md`](layouts/index.md) — Layout library — индекс

## landing-reference

- [`landings/manufacturing-reference.md`](landings/manufacturing-reference.md) — Manufacturing landing — reference

## brand

- [`brand/redpolitika.md`](brand/redpolitika.md) — Редполитика Kaiten — источник истины по языку и тону
