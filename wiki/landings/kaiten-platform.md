...
- **sections used:** `hero, benefits_strip, social_proof, media_copy, media_copy, media_copy, stats, features, process, promo_banner, pricing, faq, final_cta, footer`
...
- **visual:** `product_screenshot` (assetId: `kaiten-platform-board`)
