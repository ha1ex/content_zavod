...
- **Форма — целевое действие.** `RegistrationForm`: имя\*, email\*, телефон +
  обязательный блок согласий `FormConsent` (правило `form-consent-standard`):
  обязательное согласие 152-ФЗ + опциональная рассылка, фикс. юр-ссылки Кайтен.
  Поле «Компания / роль» — опционально (на эталоне убрано). Endpoint — из
