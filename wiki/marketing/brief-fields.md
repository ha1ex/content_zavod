...
Готовый layout-плейбук. Если указан — фаза P2 (выбор макета) пройдёт быстрее и предсказуемее; если нет — конвейер выберет макет сам на P2.
...
- `kaiten-factory.json` — минимальный пример самого harness'а
