...
| `ModuleTaskCardMock` | `module-task-card` | Доска «Маркетинг» с открытым справа окном карточки «Промостраница новой функции»: параметры, чек-лист, описание, дочерние карточки, комментарий. Анимация: наведение, щелчок, окно выезжает. 1360px |
